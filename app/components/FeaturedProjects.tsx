...
const projects: Project[] = [
  ...
  },
  {
    ...
    title: "AI Spreadsheet Agent with Voice Assistant",
    description:
      "AI-powered spreadsheet agent that allows users to perform complex spreadsheet operations using natural language.",
    technologies: ["React", "NextJS", "Anthropic API", "ElevenLabs API"],
    preview:
      "https://jykwuj67zoq0njsv.public.blob.vercel-storage.com/Untitled%20design.gif",
    link: "https://github.com/Pmahindra93/excelify",
  },
  {
    id: "llm-api",
    title: "Bank Statement Analyzer",
    description:
      "A scalable service for analyzing bank statements and extracting relevant information.",
